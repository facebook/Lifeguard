...
class ReferenceType(Generic[_T]):  # "weakref"
    ...
    def __new__(cls, o: _T, callback: Callable[[Self], Any] | None = ..., /) -> Self: unsafe()
    def __call__(self) -> _T | None: no_effects()
    def __eq__(self, value: object, /) -> bool: ...
...
class WeakMethod(ref[_CallableT]):
    def __new__(cls, meth: _CallableT, callback: Callable[[Self], Any] | None = None) -> Self: unsafe()
    def __call__(self) -> _CallableT | None: no_effects()
...
class WeakValueDictionary(MutableMapping[_KT, _VT]):
    ...
    def keys(self) -> Iterator[_KT]: no_effects()  # type: ignore[override]
    def values(self) -> Iterator[_VT]: no_effects()  # type: ignore[override]
    def items(self) -> Iterator[tuple[_KT, _VT]]: no_effects()  # type: ignore[override]
    def itervaluerefs(self) -> Iterator[KeyedRef[_KT, _VT]]: ...
    def valuerefs(self) -> list[KeyedRef[_KT, _VT]]: ...
    def setdefault(self, key: _KT, default: _VT) -> _VT: mutation()
    @overload
    ...
    @overload
    def update(self, other: SupportsKeysAndGetItem[_KT, _VT], /, **kwargs: _VT) -> None: mutation()
    @overload
    ...
    def __ior__(self, other: SupportsKeysAndGetItem[_KT, _VT]) -> Self: mutation()
    @overload
    def __ior__(self, other: Iterable[tuple[_KT, _VT]]) -> Self: ...

class KeyedRef(ref[_T], Generic[_KT, _T]):
    key: _KT
    def __new__(type, ob: _T, callback: Callable[[Self], Any], key: _KT) -> Self: unsafe()
    def __init__(self, ob: _T, callback: Callable[[Self], Any], key: _KT) -> None: unsafe()
...
class WeakKeyDictionary(MutableMapping[_KT, _VT]):
    ...
    def values(self) -> Iterator[_VT]: no_effects()  # type: ignore[override]
    def items(self) -> Iterator[tuple[_KT, _VT]]: no_effects()  # type: ignore[override]
    def keyrefs(self) -> list[ref[_KT]]: no_effects()
    # Keep WeakKeyDictionary.setdefault in line with MutableMapping.setdefault, modulo positional-only differences
    @overload
    def setdefault(self: WeakKeyDictionary[_KT, _VT | None], key: _KT, default: None = None) -> _VT: mutation()
    @overload
    ...
    def pop(self, key: _KT, default: _T) -> _VT | _T: ...
    @overload
    def update(self, dict: SupportsKeysAndGetItem[_KT, _VT], /, **kwargs: _VT) -> None: mutation()
    @overload
...
class finalize(Generic[_P, _T]):
    def __init__(self, obj: _T, func: Callable[_P, Any], /, *args: _P.args, **kwargs: _P.kwargs) -> None: unsafe()
    def __call__(self, _: Any = None) -> Any | None: unsafe()
    def detach(self) -> tuple[_T, Callable[_P, Any], tuple[Any, ...], dict[str, Any]] | None: unsafe()
    def peek(self) -> tuple[_T, Callable[_P, Any], tuple[Any, ...], dict[str, Any]] | None: no_effects()
    @property
    def alive(self) -> bool: no_effects()
    atexit: bool
